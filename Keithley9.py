...
class KeithleyMonitor(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.window_size = 10  # Default number of measurements for moving average
    ...
    def calculate_moving_stats(self):
        """Calculate moving average and standard deviation of the last n measurements"""
